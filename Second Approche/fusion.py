...
Original file is located at
    https://colab.research.google.com/drive/1INw_zpz6Q4Ez3HL7nMZjl5Qxc0UZojoU
...
if __name__ == '__main__':
    ...
    parser.add_argument('-embsWav2vec', '--embs_dir_wav2vec', type=str, default='',
                        help='Path with the embeddings of the fine-tuned Wav2Vec model')
    parser.add_argument('-embsBiLSTM', '--embs_dir_biLSTM', type=str, default='',
                        help='Path with the embeddings of the bi-LSTM with attention mechanism trained with the AUs')
    parser.add_argument('-embsMLP', '--embs_dir_MLP', type=str, default='',
    ...
    for fold in range(5):
        ...
        #Combine data
        #
        X_train_MM = pd.concat([X_train_audio, X_train_video], axis=1) #X_train_audio_avg[["embs"+str(i) for i in range(8)]]
        #
        X_test_MM = pd.concat([X_test_audio, X_test_video], axis=1) #X_test_audio_avg[["embs"+str(i) for i in range(8)]]
